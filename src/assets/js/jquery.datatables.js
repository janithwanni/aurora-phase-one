...
(function (c) {
  ...
  c.extend(j.prototype, {
    _constructor: function () {
      ...
      var a = this, b = this.s.dt, d = c(l).width(), e = this.c.breakpoints, f = e[0].name, g = this.s.columns, h,
        j = this.s.current.slice();
      ...
      e = !1;
      h = 0;
      for (d = g.length; h < d; h++) if (!1 === i[h] && !g[h].never &&
        !g[h].control) {
        e = !0;
        break
      }
      ...
      if (this.c.auto && -1 !== c.inArray(!0, c.map(b, function (a) {
        ...
        a.table().node();
        var d = a.table().node().cloneNode(!1), e = c(a.table().header().cloneNode(!1)).appendTo(d),
